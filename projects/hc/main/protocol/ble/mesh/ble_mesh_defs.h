 ...
 */
#define BLE_MESH_MODEL_OP(_opcode, _min_len) \
{ \
    .opcode = _opcode, \
    .min_len = _min_len, \
 ...
 */
#define BLE_MESH_MODEL_OP_END {0, 0, 0}
...
#define BLE_MESH_MODEL_OP_BEACON_GET                            BLE_MESH_MODEL_OP_2(0x80, 0x09) /*!< Config Beacon Get */
#define BLE_MESH_MODEL_OP_COMPOSITION_DATA_GET                  BLE_MESH_MODEL_OP_2(0x80, 0x08) /*!< Config Composition Data Get */
#define BLE_MESH_MODEL_OP_DEFAULT_TTL_GET                       BLE_MESH_MODEL_OP_2(0x80, 0x0C) /*!< Config Default TTL Get */
#define BLE_MESH_MODEL_OP_GATT_PROXY_GET                        BLE_MESH_MODEL_OP_2(0x80, 0x12) /*!< Config GATT Proxy Get */
#define BLE_MESH_MODEL_OP_RELAY_GET                             BLE_MESH_MODEL_OP_2(0x80, 0x26) /*!< Config Relay Get */
#define BLE_MESH_MODEL_OP_MODEL_PUB_GET                         BLE_MESH_MODEL_OP_2(0x80, 0x18) /*!< Config Model Publication Get */
#define BLE_MESH_MODEL_OP_FRIEND_GET                            BLE_MESH_MODEL_OP_2(0x80, 0x0F) /*!< Config Friend Get */
#define BLE_MESH_MODEL_OP_HEARTBEAT_PUB_GET                     BLE_MESH_MODEL_OP_2(0x80, 0x38) /*!< Config Heartbeat Publication Get */
#define BLE_MESH_MODEL_OP_HEARTBEAT_SUB_GET                     BLE_MESH_MODEL_OP_2(0x80, 0x3a) /*!< Config Heartbeat Subscription Get */
#define BLE_MESH_MODEL_OP_NET_KEY_GET                           BLE_MESH_MODEL_OP_2(0x80, 0x42) /*!< Config NetKey Get */
#define BLE_MESH_MODEL_OP_APP_KEY_GET                           BLE_MESH_MODEL_OP_2(0x80, 0x01) /*!< Config AppKey Get */
#define BLE_MESH_MODEL_OP_NODE_IDENTITY_GET                     BLE_MESH_MODEL_OP_2(0x80, 0x46) /*!< Config Node Identity Get */
#define BLE_MESH_MODEL_OP_SIG_MODEL_SUB_GET                     BLE_MESH_MODEL_OP_2(0x80, 0x29) /*!< Config SIG Model Subscription Get */
#define BLE_MESH_MODEL_OP_VENDOR_MODEL_SUB_GET                  BLE_MESH_MODEL_OP_2(0x80, 0x2B) /*!< Config Vendor Model Subscription Get */
#define BLE_MESH_MODEL_OP_SIG_MODEL_APP_GET                     BLE_MESH_MODEL_OP_2(0x80, 0x4B) /*!< Config SIG Model App Get */
#define BLE_MESH_MODEL_OP_VENDOR_MODEL_APP_GET                  BLE_MESH_MODEL_OP_2(0x80, 0x4D) /*!< Config Vendor Model App Get */
#define BLE_MESH_MODEL_OP_KEY_REFRESH_PHASE_GET                 BLE_MESH_MODEL_OP_2(0x80, 0x15) /*!< Config Key Refresh Phase Get */
#define BLE_MESH_MODEL_OP_LPN_POLLTIMEOUT_GET                   BLE_MESH_MODEL_OP_2(0x80, 0x2D) /*!< Config Low Power Node PollTimeout Get */
#define BLE_MESH_MODEL_OP_NETWORK_TRANSMIT_GET                  BLE_MESH_MODEL_OP_2(0x80, 0x23) /*!< Config Network Transmit Get */
...
#define BLE_MESH_MODEL_OP_BEACON_SET                            BLE_MESH_MODEL_OP_2(0x80, 0x0A) /*!< Config Beacon Set */
#define BLE_MESH_MODEL_OP_DEFAULT_TTL_SET                       BLE_MESH_MODEL_OP_2(0x80, 0x0D) /*!< Config Default TTL Set */
#define BLE_MESH_MODEL_OP_GATT_PROXY_SET                        BLE_MESH_MODEL_OP_2(0x80, 0x13) /*!< Config GATT Proxy Set */
#define BLE_MESH_MODEL_OP_RELAY_SET                             BLE_MESH_MODEL_OP_2(0x80, 0x27) /*!< Config Relay Set */
#define BLE_MESH_MODEL_OP_MODEL_PUB_SET                         BLE_MESH_MODEL_OP_1(0x03)       /*!< Config Model Publication Set */
#define BLE_MESH_MODEL_OP_MODEL_SUB_ADD                         BLE_MESH_MODEL_OP_2(0x80, 0x1B) /*!< Config Model Subscription Add */
#define BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_ADD            BLE_MESH_MODEL_OP_2(0x80, 0x20) /*!< Config Model Subscription Virtual Address Add */
#define BLE_MESH_MODEL_OP_MODEL_SUB_DELETE                      BLE_MESH_MODEL_OP_2(0x80, 0x1C) /*!< Config Model Subscription Delete */
#define BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_DELETE         BLE_MESH_MODEL_OP_2(0x80, 0x21) /*!< Config Model Subscription Virtual Address Delete */
#define BLE_MESH_MODEL_OP_MODEL_SUB_OVERWRITE                   BLE_MESH_MODEL_OP_2(0x80, 0x1E) /*!< Config Model Subscription Overwrite */
#define BLE_MESH_MODEL_OP_MODEL_SUB_VIRTUAL_ADDR_OVERWRITE      BLE_MESH_MODEL_OP_2(0x80, 0x22) /*!< Config Model Subscription Virtual Address Overwrite */
#define BLE_MESH_MODEL_OP_NET_KEY_ADD                           BLE_MESH_MODEL_OP_2(0x80, 0x40) /*!< Config NetKey Add */
#define BLE_MESH_MODEL_OP_APP_KEY_ADD                           BLE_MESH_MODEL_OP_1(0x00)       /*!< Config AppKey Add */
#define BLE_MESH_MODEL_OP_MODEL_APP_BIND                        BLE_MESH_MODEL_OP_2(0x80, 0x3D) /*!< Config Model App Bind */
#define BLE_MESH_MODEL_OP_NODE_RESET                            BLE_MESH_MODEL_OP_2(0x80, 0x49) /*!< Config Node Reset */
#define BLE_MESH_MODEL_OP_FRIEND_SET                            BLE_MESH_MODEL_OP_2(0x80, 0x10) /*!< Config Friend Set */
#define BLE_MESH_MODEL_OP_HEARTBEAT_PUB_SET                     BLE_MESH_MODEL_OP_2(0x80, 0x39) /*!< Config Heartbeat Publication Set */
#define BLE_MESH_MODEL_OP_HEARTBEAT_SUB_SET                     BLE_MESH_MODEL_OP_2(0x80, 0x3B) /*!< Config Heartbeat Subscription Set */
#define BLE_MESH_MODEL_OP_NET_KEY_UPDATE                        BLE_MESH_MODEL_OP_2(0x80, 0x45) /*!< Config NetKey Update */
#define BLE_MESH_MODEL_OP_NET_KEY_DELETE                        BLE_MESH_MODEL_OP_2(0x80, 0x41) /*!< Config NetKey Delete */
#define BLE_MESH_MODEL_OP_APP_KEY_UPDATE                        BLE_MESH_MODEL_OP_1(0x01)       /*!< Config AppKey Update */
#define BLE_MESH_MODEL_OP_APP_KEY_DELETE                        BLE_MESH_MODEL_OP_2(0x80, 0x00) /*!< Config AppKey Delete */
#define BLE_MESH_MODEL_OP_NODE_IDENTITY_SET                     BLE_MESH_MODEL_OP_2(0x80, 0x47) /*!< Config Node Identity Set */
#define BLE_MESH_MODEL_OP_KEY_REFRESH_PHASE_SET                 BLE_MESH_MODEL_OP_2(0x80, 0x16) /*!< Config Key Refresh Phase Set */
#define BLE_MESH_MODEL_OP_MODEL_PUB_VIRTUAL_ADDR_SET            BLE_MESH_MODEL_OP_2(0x80, 0x1A) /*!< Config Model Publication Virtual Address Set */
#define BLE_MESH_MODEL_OP_MODEL_SUB_DELETE_ALL                  BLE_MESH_MODEL_OP_2(0x80, 0x1D) /*!< Config Model Subscription Delete All */
#define BLE_MESH_MODEL_OP_MODEL_APP_UNBIND                      BLE_MESH_MODEL_OP_2(0x80, 0x3F) /*!< Config Model App Unbind */
#define BLE_MESH_MODEL_OP_NETWORK_TRANSMIT_SET                  BLE_MESH_MODEL_OP_2(0x80, 0x24) /*!< Config Network Transmit Set */
...
#define BLE_MESH_MODEL_OP_BEACON_STATUS                         BLE_MESH_MODEL_OP_2(0x80, 0x0B)
#define BLE_MESH_MODEL_OP_COMPOSITION_DATA_STATUS               BLE_MESH_MODEL_OP_1(0x02)
#define BLE_MESH_MODEL_OP_DEFAULT_TTL_STATUS                    BLE_MESH_MODEL_OP_2(0x80, 0x0E)
#define BLE_MESH_MODEL_OP_GATT_PROXY_STATUS                     BLE_MESH_MODEL_OP_2(0x80, 0x14)
#define BLE_MESH_MODEL_OP_RELAY_STATUS                          BLE_MESH_MODEL_OP_2(0x80, 0x28)
#define BLE_MESH_MODEL_OP_MODEL_PUB_STATUS                      BLE_MESH_MODEL_OP_2(0x80, 0x19)
#define BLE_MESH_MODEL_OP_MODEL_SUB_STATUS                      BLE_MESH_MODEL_OP_2(0x80, 0x1F)
#define BLE_MESH_MODEL_OP_SIG_MODEL_SUB_LIST                    BLE_MESH_MODEL_OP_2(0x80, 0x2A)
#define BLE_MESH_MODEL_OP_VENDOR_MODEL_SUB_LIST                 BLE_MESH_MODEL_OP_2(0x80, 0x2C)
#define BLE_MESH_MODEL_OP_NET_KEY_STATUS                        BLE_MESH_MODEL_OP_2(0x80, 0x44)
#define BLE_MESH_MODEL_OP_NET_KEY_LIST                          BLE_MESH_MODEL_OP_2(0x80, 0x43)
#define BLE_MESH_MODEL_OP_APP_KEY_STATUS                        BLE_MESH_MODEL_OP_2(0x80, 0x03)
#define BLE_MESH_MODEL_OP_APP_KEY_LIST                          BLE_MESH_MODEL_OP_2(0x80, 0x02)
#define BLE_MESH_MODEL_OP_NODE_IDENTITY_STATUS                  BLE_MESH_MODEL_OP_2(0x80, 0x48)
#define BLE_MESH_MODEL_OP_MODEL_APP_STATUS                      BLE_MESH_MODEL_OP_2(0x80, 0x3E)
#define BLE_MESH_MODEL_OP_SIG_MODEL_APP_LIST                    BLE_MESH_MODEL_OP_2(0x80, 0x4C)
#define BLE_MESH_MODEL_OP_VENDOR_MODEL_APP_LIST                 BLE_MESH_MODEL_OP_2(0x80, 0x4E)
#define BLE_MESH_MODEL_OP_NODE_RESET_STATUS                     BLE_MESH_MODEL_OP_2(0x80, 0x4A)
#define BLE_MESH_MODEL_OP_FRIEND_STATUS                         BLE_MESH_MODEL_OP_2(0x80, 0x11)
#define BLE_MESH_MODEL_OP_KEY_REFRESH_PHASE_STATUS              BLE_MESH_MODEL_OP_2(0x80, 0x17)
#define BLE_MESH_MODEL_OP_HEARTBEAT_PUB_STATUS                  BLE_MESH_MODEL_OP_1(0x06)
#define BLE_MESH_MODEL_OP_HEARTBEAT_SUB_STATUS                  BLE_MESH_MODEL_OP_2(0x80, 0x3C)
#define BLE_MESH_MODEL_OP_LPN_POLLTIMEOUT_STATUS                BLE_MESH_MODEL_OP_2(0x80, 0x2E)
#define BLE_MESH_MODEL_OP_NETWORK_TRANSMIT_STATUS               BLE_MESH_MODEL_OP_2(0x80, 0x25)
...
#define BLE_MESH_MODEL_OP_HEALTH_FAULT_GET                      BLE_MESH_MODEL_OP_2(0x80, 0x31) /*!< Health Fault Get */
#define BLE_MESH_MODEL_OP_HEALTH_PERIOD_GET                     BLE_MESH_MODEL_OP_2(0x80, 0x34) /*!< Health Period Get */
#define BLE_MESH_MODEL_OP_ATTENTION_GET                         BLE_MESH_MODEL_OP_2(0x80, 0x04) /*!< Health Attention Get */
...
#define BLE_MESH_MODEL_OP_HEALTH_FAULT_CLEAR                    BLE_MESH_MODEL_OP_2(0x80, 0x2F) /*!< Health Fault Clear */
#define BLE_MESH_MODEL_OP_HEALTH_FAULT_CLEAR_UNACK              BLE_MESH_MODEL_OP_2(0x80, 0x30) /*!< Health Fault Clear Unacknowledged */
#define BLE_MESH_MODEL_OP_HEALTH_FAULT_TEST                     BLE_MESH_MODEL_OP_2(0x80, 0x32) /*!< Health Fault Test */
#define BLE_MESH_MODEL_OP_HEALTH_FAULT_TEST_UNACK               BLE_MESH_MODEL_OP_2(0x80, 0x33) /*!< Health Fault Test Unacknowledged */
#define BLE_MESH_MODEL_OP_HEALTH_PERIOD_SET                     BLE_MESH_MODEL_OP_2(0x80, 0x35) /*!< Health Period Set */
#define BLE_MESH_MODEL_OP_HEALTH_PERIOD_SET_UNACK               BLE_MESH_MODEL_OP_2(0x80, 0x36) /*!< Health Period Set Unacknowledged */
#define BLE_MESH_MODEL_OP_ATTENTION_SET                         BLE_MESH_MODEL_OP_2(0x80, 0x05) /*!< Health Attention Set */
#define BLE_MESH_MODEL_OP_ATTENTION_SET_UNACK                   BLE_MESH_MODEL_OP_2(0x80, 0x06) /*!< Health Attention Set Unacknowledged */
...
#define BLE_MESH_MODEL_OP_HEALTH_CURRENT_STATUS                 BLE_MESH_MODEL_OP_1(0x04)
#define BLE_MESH_MODEL_OP_HEALTH_FAULT_STATUS                   BLE_MESH_MODEL_OP_1(0x05)
#define BLE_MESH_MODEL_OP_HEALTH_PERIOD_STATUS                  BLE_MESH_MODEL_OP_2(0x80, 0x37)
#define BLE_MESH_MODEL_OP_ATTENTION_STATUS                      BLE_MESH_MODEL_OP_2(0x80, 0x07)
...
#define BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_GET       BLE_MESH_MODEL_OP_2(0x82, 0x2A)
#define BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_STATUS    BLE_MESH_MODEL_OP_1(0x43)
#define BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_GET         BLE_MESH_MODEL_OP_2(0x82, 0x2B)
#define BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET         BLE_MESH_MODEL_OP_1(0x44)
#define BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET_UNACK   BLE_MESH_MODEL_OP_1(0x45)
#define BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_STATUS      BLE_MESH_MODEL_OP_1(0x46)
...
typedef enum {
    BLE_MESH_MODEL_OPERATION_EVT,                   /*!< User-defined models receive messages from peer devices (e.g. get, set, status, etc) event */
...
typedef union {
    /**
     * @brief BLE_MESH_MODEL_OPERATION_EVT
     */
    ...
    } model_operation;                  /*!< Event parameter of BLE_MESH_MODEL_OPERATION_EVT */
    /**
